...
export const skills: Skill[] = [
  ...
  { name: 'JavaScript', color: '#F7DF1E', category: 'Languages',      icon: <DevIcon name="javascript"  alt="JavaScript" /> },
  { name: 'TypeScript', color: '#3178C6', category: 'Languages',      icon: <DevIcon name="typescript"  alt="TypeScript" /> },
  ...
  // ── Frontend ─────────────────────────────────────────────────────────────
  { name: 'React',       color: '#61DAFB', category: 'Frontend',      icon: <DevIcon name="react"       alt="React" /> },
  { name: 'Next.js',     color: '#000000', category: 'Frontend', invertDark: true, icon: <DevIcon name="nextjs"  variant="plain" alt="Next.js" /> },
  { name: 'Tailwind CSS',color: '#06B6D4', category: 'Frontend',      icon: <DevIcon name="tailwindcss" variant="original" alt="Tailwind CSS" /> },
  ...
  // ── Backend & APIs ────────────────────────────────────────────────────────
  { name: 'Node.js',    color: '#339933', category: 'Backend & APIs', icon: <DevIcon name="nodejs"      variant="plain" alt="Node.js" /> },
  ...
  // ── Database ──────────────────────────────────────────────────────────────
  { name: 'PostgreSQL', color: '#4169E1', category: 'Database',       icon: <DevIcon name="postgresql"  alt="PostgreSQL" /> },
  ...
  // ── Mobile & IoT ──────────────────────────────────────────────────────────
{ name: 'Expo',         color: '#000020', category: 'Mobile & IoT', invertDark: true, icon: <SIIcon  slug="expo"       color="000000" alt="Expo" /> },
